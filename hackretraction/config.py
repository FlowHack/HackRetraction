...
DEFAULT_CONFIG: dict[str, object] = {
    ...
    "firmware": "marlin",  # klipper | marlin | reprapfirmware | repetier
}

# Ключи настроек, редактируемых через UI (без секретов).
SETTINGS_KEYS: tuple[str, ...] = (
    "theme", "font_size", "font_style", "language", "comment_lang", "firmware",
)
...
# Типы прошивки принтера (влияют на дефолтный стартовый gcode).
FIRMWARES: tuple[str, ...] = ("klipper", "marlin", "reprapfirmware", "repetier")
