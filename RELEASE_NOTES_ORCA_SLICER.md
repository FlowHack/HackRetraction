...
- Pull parameters from the active profile: nozzle, bed size, layer height, flow ratio, speeds, temperatures, start/end G-code; extruder type detection (bowden/direct).
...
- Negative incremental steps are rejected.
